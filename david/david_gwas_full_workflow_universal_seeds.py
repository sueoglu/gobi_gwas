...
plt.title("R² Score")
plt.savefig("../universal_data/models/LinearRegression/performances/r2_boxplots_all_seeds_h2_vs_nCausal.png")
plt.close()

sns.boxplot(data=results_df, x="n_causal", y="spearman", hue="h2")
plt.title("Spearman Correlation")
plt.savefig("../universal_data/models/LinearRegression/performances/spearman_boxplots_all_seeds_h2_vs_nCausal.png")
