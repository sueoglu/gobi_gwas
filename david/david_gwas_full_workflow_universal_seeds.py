...
plt.title(r"$R^{2}$ - Standard Deviation Across Seeds")
...
plt.title(r"$R^{2}$ - Mean Across Seeds")
plt.xlabel("Number of causal SNPs")
plt.ylabel("Heritability")
...
plt.title(r"$R^{2}$ - Coefficient of Variation Across Seeds")
plt.xlabel("Number of causal SNPs")
plt.ylabel("Heritability")
plt.savefig("../universal_data/models/LinearRegression/performances/r2_heatmap_cv_all_seeds.png")
plt.close()

spearman_mean = spearman_cube.mean(axis=0)
spearman_std = spearman_cube.std(axis=0)
spearman_cv = spearman_std / spearman_mean
print("Mean over seeds: ",spearman_mean)
print("Std over seeds: ",spearman_std)
print("Coefficient of Variation: ", spearman_cv)

spearman_mean_df = pd.DataFrame(spearman_mean, index=h2s, columns=n_causals)
spearman_std_df = pd.DataFrame(spearman_std, index=h2s, columns=n_causals)
spearman_cv_df = pd.DataFrame(spearman_cv, index=h2s, columns=n_causals)

sns.heatmap(spearman_std_df, annot=False, cmap="YlOrBr")
plt.title("Spearman - Standard Deviation Across Seeds")
plt.xlabel("Number of causal SNPs")
plt.ylabel("Heritability")
plt.savefig("../universal_data/models/LinearRegression/performances/spearman_heatmap_std_all_seeds.png")
plt.close()
sns.heatmap(spearman_mean_df, annot=False, cmap="YlOrBr")
plt.title("Spearman - Mean Across Seeds")
plt.xlabel("Number of causal SNPs")
plt.ylabel("Heritability")
plt.savefig("../universal_data/models/LinearRegression/performances/spearman_heatmap_mean_all_seeds.png")
plt.close()
sns.heatmap(spearman_cv_df, annot=False, cmap="YlOrBr")
plt.title("Spearman - Coefficient of Variation Across Seeds")
plt.xlabel("Number of causal SNPs")
plt.ylabel("Heritability")
plt.savefig("../universal_data/models/LinearRegression/performances/spearman_heatmap_cv_all_seeds.png")
plt.close()

sns.boxplot(data=results_df, x="n_causal", y="r2", hue="h2", palette=sns.color_palette("Blues"))
plt.legend(title=r"$h^{2}$", loc='upper left', bbox_to_anchor=(1, 1))
plt.title(r"$R^{2}$ Score")
plt.xlabel("Number of causal SNPs")
plt.ylabel(r"$R^{2}$")
plt.tight_layout()
plt.savefig("../universal_data/models/LinearRegression/performances/r2_boxplots_all_seeds_h2_vs_nCausal.png", bbox_inches="tight")
plt.close()

sns.boxplot(data=results_df, x="n_causal", y="spearman", hue="h2", palette=sns.color_palette("YlOrBr"))
plt.legend(title=r"$h^{2}$", loc='upper left', bbox_to_anchor=(1, 1))
plt.title("Spearman Correlation")
plt.xlabel("Number of causal SNPs")
plt.ylabel(r'$r_{s}$')
plt.tight_layout()
plt.savefig("../universal_data/models/LinearRegression/performances/spearman_boxplots_all_seeds_h2_vs_nCausal.png", bbox_inches="tight")
